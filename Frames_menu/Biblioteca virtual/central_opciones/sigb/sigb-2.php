...
<body background="../../Imagenes/fondo.jpg">
		...
		<table bgcolor="#2C3539" width="100%" border="0" align="center" cellspacing="2" cellpadding="0">
			<tr>
				<td align="center" height="60">
					...
					<tr><td align="justify">
					<font size="4" color="#FFFFFF">¡AVISO! Para el servicio de prestamo de libros se requiere una cuenta de usuario, si 
						aun no lo tienes por favor dirigirse a la parte de Servicios en solicitud de cuenta, para que nuestro personal administrativo
		...
		if(isset($_POST['Buscar'])){
			...
			if (isset($_POST['text']) and $_POST['text'] !=""){
				...
				echo "<table bordercolor=black width=90% border=3 align=center cellspacing=5 cellpadding=4 class=celda>
						<tr valign=middle align=center>
							<td bgcolor=#FFE5B4align=center height=70 width=16%> <p><img width=100% src=Imagenes/$ref alt=libro1/></p></td>
	...
	<section>
		...
		<font size="6" face="Agency FB"><b>&nbsp;&nbsp;SOLICITAR LIBROS</b></font><br><br>
	...
	<section>
		<article>
		<br><img src="../../Imagenes/seccion.png" alt="seccion"/><font size="6" face="Agency FB"><b>&nbsp;&nbsp;LIBROS MÁS BUSCADOS</b></font><br><br>
		<table bordercolor="black" width="95%" border="3" align="center" cellspacing="10" cellpadding="4">			
			<tr valign="middle" align="center">
				<td bgcolor="#FFE5B4"align="center" height="70" width="16%"> <p><img width="100%" src="Imagenes/libro5.jpg" alt="libro5"/></p></td>
				<td bgcolor="#EBF4FA" align="justify" height="70"> <p><font size="5" face="Agency FB"><a href="sigb-2-libro5.html" class="titulo3">Análisis y 
				Diseño de Sistemas de Información</a><br>
				<font size="3">por Senn, James.</font><br>
				<font size="4">Clasificación COD: 004.21 / S3</font>
				<p><font size="4">Tipo de material: Texto<img src="Imagenes/book.png" alt="libro"/> | Formato: impreso | Forma literaria: No es ficción<br>
				Pie de imprenta: México, D.F. McGraw-Hill Interamericana de México S.A. 1992<br>
				Disponibilidad: Ítems disponibles para préstamo: Electrónica e Informática (2).</font></p></font></p>
		    	</td>		
			</tr>
			<tr valign="middle" align="center">
				<td bgcolor="#FFE5B4"align="center" height="70" width="16%"> <p><img width="100%" src="Imagenes/libro6.jpg" alt="libro6"/></p></td>
				<td bgcolor="#EBF4FA" align="justify" height="70">
				<p><font size="5" face="Agency FB"><a href="sigb-2-libro6.html" class="titulo3">Análisis dinámico de sistemas industriales posicionamiento 
				científico, enfoque global,método,casos prácticos</a><br>
				<font size="3">por Cedillo Campos, Miguel Gastón.</font><br>
				<font size="4">Clasificación COD: 620.72 / C32</font>
				<p><font size="4">Tipo de material: Texto<img src="Imagenes/book.png" alt="libro"/> | Formato: impreso | Forma literaria: No es ficción<br>
				Pie de imprenta: México D.F. Trillas 2008<br>
				Disponibilidad: Ítems disponibles para préstamo: Industrial y Sistemas (3).</font></p></font></p>   
			</td>

			</tr>
			<tr valign="middle" align="center">
				<td bgcolor="#FFE5B4"align="center" height="70" width="16%"> <p><img width="100%" src="Imagenes/libro7.jpg" alt="libro7"/></p></td>
				<td bgcolor="#EBF4FA" align="justify" height="70">
				<p><font size="5" face="Agency FB"><a href="sigb-2-libro7.html" class="titulo3">Análisis de fallos en sistemas aeronáuticos</a><br>
				<font size="3">por De Santis, Augusto Javier.</font><br>
				<font size="4">Clasificación COD: 386 / S15</font>
				<p><font size="4">Tipo de material: Texto<img src="Imagenes/book.png" alt="libro"/> | Formato: impreso | Forma literaria: No es ficción<br>
				Pie de imprenta: Madrid Paraninfo 2015<br>
				Disponibilidad: Ítems disponibles para préstamo: Industrial y Sistemas (1).</font></p></font></p>
			    </td>
			</tr>
			<tr valign="middle" align="center">
				<td bgcolor="#FFE5B4"align="center" height="70" width="16%"> <p><img width="100%" src="Imagenes/libro8.jpg" alt="libro8"/></p></td>
				<td bgcolor="#EBF4FA" align="justify" height="70">
				<p><font size="5" face="Agency FB"><a href="sigb-2-libro8.html" class="titulo3">Análisis de Sistemas de Potencia</a><br>
				<font size="3">por Grainger, John J.</font><br>
				<font size="4">Clasificación COD: 621.381044 / G7</font>
				<p><font size="4">Tipo de material: Texto<img src="Imagenes/book.png" alt="libro"/> | Formato: impreso | Forma literaria: No es ficción<br>
				Pie de imprenta: México, D.F. McGraw-Hill Interamericana de México S.A. 1996<br>
				Disponibilidad: Ítems disponibles para préstamo: Electrónica e Informática (1).</font></p></font></p>
			</td>
			</tr>
		</table>
		<br>
						...
						<table align="center" width="100%" cellspacing="0px" cellpadding="5px" style="font-size:20px;">
							<tr>
								<td style="border-right:4px solid #FFA347;border-radius: 15px 0px 0px 15px;" class="celda1" width="100px" align="center">
									<a class="letra" href="sigb-1.php">Anterior</a> 
								</td>
		...
		<article>
			<img src="../../Imagenes/seccion.png" alt="seccion"/><font size="6" face="Agency FB"><b>&nbsp;&nbsp;LIBROS POR ESCUELA</b></font><br><br>
			<table bordercolor="black" width="95%" border="3" align="center" cellspacing="0" cellpadding="10">			
				<tr valign="middle" align="center">
					<td bgcolor="#E5E4E2"align="center" height="50" width="25%" class="efecto"><a class="titulo2" href="Facultad/fac-1.php" target="marco"><b>Ingenieria de Sistemas</b></a></td>
					<td bgcolor="#E5E4E2"align="center" height="50" width="25%" class="efecto"><a class="titulo2" href="Facultad/fac-2.php" target="marco"><b>Ingenieria Industrial</b></a></td>
					<td bgcolor="#E5E4E2"align="center" height="50" width="25%" class="efecto"><a class="titulo2" href="Facultad/fac-3.php" target="marco"><b>Ingenieria Agroindustrial</b></a></td>
					<td bgcolor="#E5E4E2"align="center" height="50" width="25%" class="efecto"><a class="titulo2" href="Facultad/fac-4.php" target="marco"><b>Ingenieria de transportes</b></a></td>
				</tr>
				<tr valign="middle" align="center">
					<td colspan="4" bgcolor="#F3E5AB" height="2070" cellpadding="0" valign="top" style="border-top: none;"> 
						<iframe src="Facultad/fac-1.php" name="marco" width="100%" height="100%" frameborder="none" margin="0" scrolling="no"> 
						</iframe>
					</td>
				</tr>
			</table>
